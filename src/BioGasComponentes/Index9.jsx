    ...
    <div className="tech-wrapper">
      ...
      <div className="tech-content">
        <p>
          ...
          augers. Inside the reactors, the substrate is maintained at a constant
          thermophilic temperature of 52°C, supported by dry cooling systems to
          prevent overheating during hot weather. The material is periodically
          mixed by vertical agitators to ensure uniform digestion conditions.
          The digestion process lasts an average of 33 days, after which the
          digestate is pumped to a separator that divides it into solid and
          liquid biofertilizer. The solid fraction is collected and transported
          for storage, while the liquid filtrate flows to a dedicated storage
          tank. Meanwhile, the biogas generated in the reactors rises and is
          transferred through pipelines to an external gas holder, which is
          protected by a durable weather-resistant membrane secured with a
          specialized fastening system to ensure safe and reliable gas storage.
        </p>
