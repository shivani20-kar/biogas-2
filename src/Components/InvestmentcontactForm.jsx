...
import "./Css/InvestmentContactFrom.css";

const InvestmentContactForm = () => {
  return (
    <div className="investmentcontact-wrapper">
      <p className="investmentcontact-top-text">
        All You Need to Know More About the Project..!<br />
        Fill Your Information
      </p>

      <div className="investmentcontact-card">
        <div className="investmentcontact-curves">
          <span></span>
          <span></span>
          <span></span>
        </div>

        <form className="investmentcontact-form">

          {/* Name */}
          <div className="investmentcontact-field">
          ...
          {/* File Upload */}
          <label className="investmentcontact-file">
            Attach File here
            <input type="file" hidden />
          </label>

          {/* Submit Button */}
          <button type="submit" className="investmentcontact-submit">
            <span className="submit-text">Submit</span>
            <span className="submit-icon"><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 15 15" fill="none">
