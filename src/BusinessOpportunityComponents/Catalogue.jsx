  ...
  return (
    <div className="catalogue-container">
      ...
      <div className="table-wrapper">
        ...
        <div className="catalogue-table-wrapper" ref={containerRef}>
          <table className="catalogue-table">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <a href="/biogas-equipment">Biogas Equipment CAT</a>
                </td>
              </tr>

              <tr>
                <td>
                  <a href="/advance-biofuel">Advance Biofuel</a>
                </td>
                <td>
                  <a href="/advance-biofuel-equipment">
                    Advance Biofuel Equipment CAT
                  </a>
                </td>
              </tr>
              ...
              <tr>
                <td>
                  <a href="/feedstock-supply">Feed stock Supply</a>
                </td>
                <td>
                  <a href="/feedstock-supply-equipment">
                    Feed stock Supply Equipment CAT
                  </a>
                </td>
              </tr>
              ...
              <tr>
                <td>
                  <a href="/biomass-pelleting">Biomass Pelleting</a>
                </td>
                <td>
                  <a href="/biomass-pelleting-equipment">
                    Biomass Pelleting Equipment CAT
                  </a>
                </td>
              </tr>
              ...
              <tr>
                <td>
                  <a href="/cdr">CO₂ removal (CDR)</a>
                </td>
                <td>
                  <a href="/cdr-equipment">CO₂ removal (CDR) Equipment CAT</a>
                </td>
              </tr>

              <tr>
                <td>
                  <a href="/agrobiogenics">Agrobiogenics</a>
                </td>
                <td>
                  <a href="/agrobiogenics-equipment">
                    Agrobiogenics Equipment CAT
                  </a>
                </td>
              </tr>
            </tbody>
