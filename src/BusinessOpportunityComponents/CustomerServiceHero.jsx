  ...
  return (
    <>
      <section className="hero">
        ...
        <div className="hero-bottom-wrapservice">
          <div className="customerservice-title">Customer Service Center</div>

          <div className="circle-elementservice">
            <img
              src={customerserviceimg}
              alt="Animation"
              className="circle-gif"
            />
          </div>
        </div>
      </section>
