...
import rentonimage from "../Components/IMAGES/rentonBackground.png";
  ...
  return (
    <>
      <section className="hero">
        {/* 🔹 Updated class */}
        <div className="rent-on">
          <img
            src={rentonimage} 
            alt="Rent On Background" 
          />
        </div>
        ...
        <div className="hero-bottom-wrap">
          <div className="rent-on-title">Long Lease Land Proposal</div>
        </div>
      </section>
    </>
  );
