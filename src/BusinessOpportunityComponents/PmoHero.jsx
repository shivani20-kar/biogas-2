...
import pmoimage from "../Components/IMAGES/PMObackhround.jpg";
  ...
  return (
    <>
      <section className="hero">
        {/* 🔹 Updated class + Updated Image */}
        <div className="pmomainbackground">
          <img src={pmoimage} alt="PMO Background" />
        </div>
