...
import ContactUSimage from "../Components/IMAGES/contactUsBackground.jpg";
    ...
    <>
      <section className="hero">
        ...
        <div className="contactUs-bg">
          <img src={ContactUSimage} alt="ContactUS Background" />
        </div>
        ...
        <div className="hero-bottom-wrap">
          <div className="contactus-title">GD Presence</div>
        </div>
      </section>
    </>
  );
